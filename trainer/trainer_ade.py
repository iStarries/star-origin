...
class Trainer_base(BaseTrainer):
    ...
    def __init__(
        ...
        self.validate_on_test = config['trainer'].get('validate_on_test', False)
        self.validate_last = config['trainer'].get('validate_last', 0)
    ...
    def _train_epoch(self, epoch):
        ...
        if (
            ...
            and self.do_test
            and self.validate_last > 0
            and epoch > self.epochs - self.validate_last
        ):
