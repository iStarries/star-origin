...
if __name__ == '__main__':
    ...
    options = [
        ...
        CustomArgs(['--phase_residual_scale'], type=float, target='phase_replay;phase_residual_scale'),
        CustomArgs(
            ['--phase_sample_mode'],
            type=str,
            target='phase_replay;phase_sample_mode',
            choices=['mixture', 'argmax'],
        ),
        CustomArgs(['--phase_gmm_components'], type=int, target='phase_replay;phase_gmm_components'),
        CustomArgs(['--phase_gmm_min_var'], type=float, target='phase_replay;phase_gmm_min_var'),
        CustomArgs(['--phase_phase_noise'], type=float, target='phase_replay;phase_noise_scale'),
        CustomArgs(['--phase_amp_noise'], type=float, target='phase_replay;amp_noise_scale'),
        CustomArgs(['--phase_use_delta'], action='store_true', target='phase_replay;phase_use_delta'),
        CustomArgs(['--phase_use_amp_stats'], action='store_true', target='phase_replay;use_amp_stats'),
        CustomArgs(['--phase_warmup_epochs'], type=int, target='phase_replay;warmup_epochs'),
